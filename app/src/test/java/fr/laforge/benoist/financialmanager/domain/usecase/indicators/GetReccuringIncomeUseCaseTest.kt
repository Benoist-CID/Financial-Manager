...
class GetReccuringIncomeUseCaseTest {
    ...
    private val useCase = GetRecurringIncomeUseCase(financialRepository)

    @Test
    fun `invoke should return correct summed income`() = runTest {
        // --- Arrange ---
        // Create dummy transactions
        val transaction1 = Transaction(amount = 1000f, type = TransactionType.Income)
        val transaction2 = Transaction(amount = 500f, type = TransactionType.Income)
